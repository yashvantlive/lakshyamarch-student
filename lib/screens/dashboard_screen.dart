        ...
        Expanded(
          child: Padding(
            ...
            child: GridView.count(
              ...
              children: [
                _buildHubTile(context, title: 'Schedule', icon: LucideIcons.calendar, color: Colors.blue, targetScreen: const ScheduleScreen()),
                _buildHubTile(context, title: 'Homework', icon: LucideIcons.clipboardList, color: Colors.orange, targetScreen: const HomeworkHistoryScreen(), badgeText: hwBadge, subtitle: hwSubtitle),
                _buildHubTile(context, title: 'Syllabus', icon: LucideIcons.bookOpen, color: Colors.teal, targetScreen: const SyllabusScreen()),
                _buildHubTile(context, title: 'Doubt Room', icon: LucideIcons.messageSquare, color: Colors.cyan, targetScreen: const DoubtRoomScreen()),
                ...
                _buildHubTile(context, title: 'Help & Complain', icon: LucideIcons.phoneCall, color: Colors.red, targetScreen: const SupportScreen()),
